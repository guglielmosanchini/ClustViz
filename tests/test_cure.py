...
def test_sel_rep():
    ...
    assert (res[0] == np.array([0.0, 0.25])).all()
...
def test_dist_mat_gen_cure():
    expected_df = pd.DataFrame(
        [[np.inf, 0, 1], [0, np.inf, 2], [1, 2, np.inf]],
        index=["0", "1", "2"],
        columns=["0", "1", "2"],
    )

    res_df = dist_mat_gen_cure(
        {"0": np.array([1, 2]), "1": np.array([2, 3]), "2": np.array([0, 0])}
    )
...
def test_cure_sample_part_1():
    X = np.array([[0, 0], [0, 1], [0, 2], [1, 2], [1, 3]])

    res = cure_sample_part(X, 2, plotting=False)

    exp = {
        "(1)-(4)": [np.array([0, 1]), np.array([1, 3])],
        "(2)-(0)": [np.array([0, 2]), np.array([0, 0])],
    }
...
def test_cure_sample_part_2():
    ...
    res = cure_sample_part(X, 2, plotting=False)
    exp2 = {
        "(1)-(4)": [np.array([0.15, 1.3]), np.array([0.85, 2.7])],
        "(2)-(0)": [np.array([0.0, 1.7]), np.array([0.0, 0.3])],
    }
...
def test_cure_2():
    ...
    exp2 = {
        "(0)-(1)": [np.array([0.0, 0.05]), np.array([0.0, 0.95])],
        "(4)-((2)-(3))": [
            np.array([0.96666667, 2.93333333]),
            np.array([0.11166667, 2.03333333]),
...
def test_cure_3():
    ...
    exp_df = pd.DataFrame(
        [
            [0.0, 0.0, 0, 1, np.nan, np.nan, np.nan, np.nan, np.nan, np.nan],
